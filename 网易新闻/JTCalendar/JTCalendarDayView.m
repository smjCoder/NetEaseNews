...
- (void)configureConstraintsForSubviews
{
    ...
    circleView.frame = CGRectMake(0, 0, sizeCircle/1.2, sizeCircle/1.2);
    circleView.center = CGPointMake(self.frame.size.width / 2., self.frame.size.height / 2.);
    circleView.layer.cornerRadius = sizeCircle / 2.;
    
    dotView.frame = CGRectMake(0, 0, sizeDot*4, sizeDot/1.3);
    dotView.center = CGPointMake(self.frame.size.width / 2., (self.frame.size.height / 2.) + sizeDot * 4);
